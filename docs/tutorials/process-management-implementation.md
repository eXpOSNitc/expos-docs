...
The start address of the [page table](../os-design/process-table.md#per_page_table) of each process is fixed by eXpOS design. The ​_GetPCBEntry_ function sets this value appropriately when it allocates a new process table entry.

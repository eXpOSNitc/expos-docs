...
!!! abstract "Pre-requisite Reading"
    Revisit the description of data structures- [Process table](../os-design/process-table.md) , [Page table](../os-design/process-table.md#per_page_table) , [System status table](../os-design/mem-ds.md#ss_table) , [Disk Map table](../os-design/process-table.md#disk_map_table) .
